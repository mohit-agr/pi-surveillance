...
class ImageUploader:
    def __init__(self, image_stream):
        ...
        try:
            ...
            self.blob_service_client = blob_service_client.get_container_client(container=container_name)
    ...
    def upload(self):
        while True:
            ...
            print('created container client' + self.blob_container_client.container_name)
